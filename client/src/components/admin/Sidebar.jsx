...
const Sidebar = ({ isOpen, toggleSidebar }) => {
    ...
    const linkClasses = "flex items-center px-4 py-2 rounded-lg transition duration-150 text-indigo-200 hover:bg-indigo-700 hover:text-white";
    ...
    return (
        ...
        >
            ...
            <div className="p-4 border-t border-indigo-700">
                ...
                <a href="/logout" className="flex items-center px-4 py-2 rounded-lg text-red-300 hover:bg-indigo-700 hover:text-red-100 transition duration-150">
