        ...
        <div className="overflow-y-auto custom-scrollbar max-h-[550px]">
          <table className="min-w-full divide-y divide-gray-200 relative">
            <thead className="bg-gray-100 sticky top-0 z-10 shadow-sm">
              <tr>
                <th className="px-6 py-4 text-center text-xs font-bold text-gray-600 uppercase w-16">
                  STT
                </th>
                ...
                <th className="hidden lg:table-cell px-6 py-4 text-left text-xs font-bold text-gray-600 uppercase">
                  Tổng Tiền
                </th>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex justify-end items-center gap-2">
                        ...
                        <button
                          onClick={() => confirmDelete(visit._id)}
      ...
      {pagination && pagination.totalPages > 1 && (
        <div className="mt-4 pt-4 border-t border-gray-200 flex justify-between items-center shrink-0">
          <span className="text-sm text-gray-500">
            Trang{" "}
            <span className="font-bold text-sky-600">{pagination.page}</span> /{" "}
