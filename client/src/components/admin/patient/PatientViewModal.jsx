...
const PatientViewModal = ({ isOpen, onClose, viewingPatient }) => {
    ...
    const getProfileCompletedBadge = (isCompleted) => {
        const style = isCompleted ? 'bg-blue-100 text-blue-800' : 'bg-yellow-100 text-yellow-800';
   ...
   const userId = viewingPatient?.user_id?._id || viewingPatient?.user_id || 'N/A';
            ...
            {viewingPatient && (
                <div className="space-y-4 text-gray-700">
                    ...
                    <div className="border-b pb-4 space-y-3">
                        <div className="grid grid-cols-2 gap-4">
                             <div>
                                ...
                                <p className="text-sm font-mono text-gray-500 truncate">{userId}</p>
                            </div>
                             <div>
                    ...
                    <div className="grid grid-cols-2 gap-4 border-t pt-3">
                        <p className="col-span-2 text-md font-bold text-gray-800 mb-1">Thông tin cơ bản</p>
                    ...
                    <div className="border-t pt-3 mt-4">
                        <p className="text-sm font-semibold text-red-700">Ghi Chú Nội Bộ:</p>
