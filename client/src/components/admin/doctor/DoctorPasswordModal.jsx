...
const DoctorPasswordModal = ({ 
    isOpen, 
    onClose, 
    doctorToChangePassword, // ← THAY THẾ CHO formData
    ...
    const handleSubmit = (e) => {
        ...
        handlePasswordChange({
            doctorId: doctorToChangePassword._id || doctorToChangePassword.id,
            newPassword: passwordData.newPassword,
        });
    };
    
    const doctorName = doctorToChangePassword?.fullName || 'Bác sĩ';

    return (
        <Modal 
            title={`Đổi Mật Khẩu cho: ${doctorName}`} 
            isOpen={isOpen} 
            onClose={onClose}
            maxWidth="sm"
        >
...
export default DoctorPasswordModal;