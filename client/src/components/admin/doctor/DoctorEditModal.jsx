            ...
            <form onSubmit={handleSave} className="space-y-6">
                    ...
                    <div className="col-span-1">
                        {currentThumbnail && (
                            <div className="flex items-center space-x-2">
                                <img src={currentThumbnail} alt="Thumbnail" className="w-12 h-12 object-cover rounded-full border border-gray-300" />
                                <button type="button" onClick={clearThumbnail} className="text-sm text-red-600 hover:text-red-800 font-medium">Xóa ảnh cũ</button>
                            </div>
                        )}
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">Nhập năm bắt đầu. Hệ thống sẽ tự tính thâm niên.</p>
                    </div>
                </div>
