    ...
    >
      <div className="flex justify-between items-center mb-4">
        ...
        <button
          ...
          className="flex items-center bg-sky-600 text-white px-4 py-2 text-sm rounded-xl font-semibold shadow-md hover:bg-sky-700 transition"
        >
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50 sticky top-0 z-10 shadow-sm">
            <tr>
              ...
              <th className="hidden sm:table-cell px-4 py-3 text-left text-xs font-bold text-gray-600 uppercase">
                Lý Do
              </th>
              <th className="px-4 py-3 text-left text-xs font-bold text-gray-600 uppercase">
                Trạng Thái
              ...
              apps
                ...
                .map((app) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-sm text-sky-700 font-bold">
                      {app.start}
                    </td>
