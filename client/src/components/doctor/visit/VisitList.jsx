...
const VisitList = ({ 
  ...
  const { page = 1, limit = 10, totalDocs = 0, totalPages = 1 } = pagination || {};
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {loading ? (
              ...
              visits.map((visit) => (
                <tr key={visit._id} className="hover:bg-gray-50 transition duration-150">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-700">
                    ...
                    <p className="text-xs text-gray-500 truncate max-w-xs" title={visit.symptoms}>
                      {visit.symptoms}
                    </p>
                  </td>
              ...
              <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                ...
                <button
                  ...
                  className={`relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0 ${
                    page >= totalPages ? "bg-gray-100 cursor-not-allowed" : "bg-white"
                  }`}
                >
