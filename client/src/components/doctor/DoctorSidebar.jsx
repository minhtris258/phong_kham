...
export default function DoctorSidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  return (
    <>
      ...
      {/* Sidebar chính */}
      <aside
        className={`fixed top-0 left-0 z-50 h-full w-72 bg-[#00B5F1] text-white transform transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 ">
          ...
          <button
            onClick={() => setSidebarOpen(false)}
            className="lg:hidden hover:text-red-300 transition"
          >
            <X className="w-6 h-6" />
          </button>
        </div>
