      ...
      <div className="max-w-md w-full space-y-8 text-center">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-gray-600">
            Có vẻ như trang bạn đang tìm kiếm đã bị xóa, thay đổi tên hoặc tạm thời không khả dụng.
          </p>
        </div>
        ...
        <p className="mt-8 text-xs text-gray-400">
          Nếu bạn cho rằng đây là lỗi hệ thống, vui lòng <a href="mailto:support@medpro.com" className="text-[#16B7D7] hover:underline">liên hệ hỗ trợ</a>.
        </p>
      </div>
    </div>
  );
