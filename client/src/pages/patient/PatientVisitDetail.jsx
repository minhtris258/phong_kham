      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
            <FileText className="text-sky-600" /> Kết Quả Khám Bệnh
          </h2>
          <p className="text-sm text-gray-500">
            Mã hồ sơ:{" "}
            <span className="font-mono text-gray-700">
              #{visit._id ? visit._id.slice(-8).toUpperCase() : "---"}
            </span>{" "}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-100 bg-sky-50/50 flex items-center gap-2">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="border-t border-dashed my-2 pt-2">
                ...
                <p className="text-sky-700 text-lg font-bold mt-1">
