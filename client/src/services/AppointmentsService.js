...
const appointmentsService = {
  ...
  cancelAppointmentByDoctor: (id, data) => api.put(`/appointments/doctor-appointments/${id}/cancel`, data),
  // Dời lịch cuộc hẹn bởi bác sĩ
rescheduleAppointmentByDoctor: (id, data) => api.put(`/appointments/doctor-appointments/${id}/reschedule`, data),
